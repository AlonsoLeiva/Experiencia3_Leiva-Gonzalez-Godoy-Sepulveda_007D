...
class Registro(models.Model):
    ...
    civil=models.ForeignKey(Civil, on_delete=models.CASCADE)
...
class Personas(models.Model):
    ...
    def __str__(self):
        return self.nombre, self.apellido, self.rut, self.email, self.contraseña, self.conficontraseña, self.region, self.direccion
